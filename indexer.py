...
def index_pdfs(pdf_folder, index_path="faiss_index", embedding_model="sentence-transformers/all-MiniLM-L6-v2"):
    """
    ...
    print(f"Creating embeddings using '{embedding_model}' (this may take a few minutes)...")
    
    # Create local embeddings - downloads model automatically on first use
...
def main():
    """Main function"""
    print("=" * 60)
    print("PDF Indexer - RAG System (Fully Local)")
    print("=" * 60)
